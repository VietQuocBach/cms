          ...
          <Grid2 container flexDirection={'column'}>
            <LinkMenuItem component={Link} to={'/dashboard'} selected={currentTab === 'dashboard'}>
              <Box mr={1.5} display={'flex'} alignItems={'center'} fontSize={24}>
                <Icon
                  icon={
                    currentTab === 'dashboard' ? 'solar:chart-square-bold-duotone' : 'solar:chart-square-line-duotone'
                  }
                />
              </Box>
              <Box>
            ...
            <LinkMenuItem component={Link} to={'/videos'} selected={currentTab === 'videos'}>
              <Box mr={1.5} display={'flex'} alignItems={'center'} fontSize={24}>
                <Icon
                  icon={
                    currentTab === 'videos' ? 'solar:video-library-bold-duotone' : 'solar:video-library-line-duotone'
                  }
                />
              </Box>
              <Box>
